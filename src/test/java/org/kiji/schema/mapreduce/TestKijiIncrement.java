...
public class TestKijiIncrement {

  @Test
  public void testWritableSerialization() throws Exception {
    final KijiIncrement increment = new KijiIncrement(
        RawEntityId.fromKijiRowKey(Bytes.toBytes("foo")),
        "family",
        "qualifier",
        10L);

    assertWritable(increment, KijiIncrement.class);
  }
}
