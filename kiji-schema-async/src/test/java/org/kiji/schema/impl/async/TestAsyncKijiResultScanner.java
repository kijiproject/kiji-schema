...
public class TestAsyncKijiResultScanner extends KijiClientTest {
  ...
  @Before
  public void setupTestAsyncKijiResultScanner() throws Exception  {
    ...
    new InstanceBuilder(tempKiji)
        ...
        .build();
    mAsyncKiji = new AsyncKijiFactory().open(tempKiji.getURI());
    mTable = (AsyncKijiTable) mAsyncKiji.openTable(TABLE_NAME);
