...
import org.kiji.schema.impl.async.AsyncHBaseSchemaTable.PreRegisteredSchema;
import org.kiji.schema.util.BytesKey;

/** Tests for AsyncHBaseSchemaTable. */
public class TestAsyncHBaseSchemaTable extends KijiClientTest {
  ...
  public void testBasicSchemaTableFunctions() throws Exception {
    ...
    Kiji kiji = new AsyncHBaseKiji(uri, HBaseConfiguration.create(), new HBaseClient(
    ...
    Assert.assertEquals(AsyncHBaseSchemaTable.PRE_REGISTERED_SCHEMA_COUNT, testSchemaAId);
