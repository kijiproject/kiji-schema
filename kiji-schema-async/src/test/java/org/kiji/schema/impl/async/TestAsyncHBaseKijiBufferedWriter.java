...
public class TestAsyncHBaseKijiBufferedWriter extends KijiClientTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestAsyncHBaseKijiBufferedWriter.class);
  ...
  public final void setupEnvironment() throws Exception {
    ...
    mBufferedWriter = mAsyncTable.getWriterFactory().openBufferedWriter();
