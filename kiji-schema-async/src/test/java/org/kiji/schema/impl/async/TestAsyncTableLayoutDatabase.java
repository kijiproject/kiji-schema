...
public class TestAsyncTableLayoutDatabase extends KijiClientTest {
  private KijiURI mKijiURI;
  private HBaseClient mHBClient;
  private AsyncTableLayoutDatabase mTableLayoutDatabase;
  ...
  public final void setupTest() throws IOException {
    ...
    final byte[] tableName =
        AsyncMetaTable.newMetaTable(mKijiURI, mHBClient);
    final String family = "layout";
    mTableLayoutDatabase = new AsyncTableLayoutDatabase(
