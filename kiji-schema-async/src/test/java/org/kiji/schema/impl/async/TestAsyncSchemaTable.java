...
import org.kiji.schema.impl.async.AsyncSchemaTable.PreRegisteredSchema;
import org.kiji.schema.util.BytesKey;

/** Tests for AsyncSchemaTable. */
public class TestAsyncSchemaTable extends KijiClientTest {
  ...
  public void testBasicSchemaTableFunctions() throws Exception {
    ...
    Kiji kiji = new AsyncKiji(uri, HBaseConfiguration.create(), new HBaseClient(
    ...
    Assert.assertEquals(AsyncSchemaTable.PRE_REGISTERED_SCHEMA_COUNT, testSchemaAId);
