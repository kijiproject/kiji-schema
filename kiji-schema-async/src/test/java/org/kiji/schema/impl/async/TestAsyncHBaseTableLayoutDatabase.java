...
public class TestAsyncHBaseTableLayoutDatabase extends KijiClientTest {
  private KijiURI mKijiURI;
  private HBaseClient mHBClient;
  private AsyncHBaseTableLayoutDatabase mTableLayoutDatabase;
  ...
  public final void setupTest() throws IOException {
    ...
    final byte[] tableName =
        AsyncHBaseMetaTable.newMetaTable(mKijiURI, mHBClient);
    final String family = "layout";
    mTableLayoutDatabase = new AsyncHBaseTableLayoutDatabase(
        mKijiURI, mHBClient, tableName, family, schemaTable);
  }
