...
public class TestAsyncHBaseKijiResult extends KijiClientTest {
  ...
  private AsyncHBaseKiji mKiji;
  private AsyncHBaseKijiTable mTable;
  private AsyncHBaseKijiTableReader mReader;

  @Before
  public void setupTestAsyncHBaseKijiResult() throws IOException {
    ...
    Kiji kiji = getKiji();
    mKiji = new AsyncHBaseKiji(kiji.getURI());
    mTable = AsyncHBaseKijiTable.downcast(mKiji.openTable("all_types_table"));
    mReader = (AsyncHBaseKijiTableReader) mTable.openTableReader();
  }

  @After
  public void cleanupTestAsyncHBaseKijiRowView() throws IOException {
    mTable.release();
    mReader.close();
    mKiji.release();
  }
