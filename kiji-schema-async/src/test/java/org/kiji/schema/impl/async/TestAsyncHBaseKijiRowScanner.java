 ...
 */
public class TestAsyncHBaseKijiRowScanner extends KijiClientTest {
  ...
  public KijiRowScanner getRowScanner(
      ...
      final KijiScannerOptions options
  ) throws IOException {
    return reader.getScanner(dataRequest, options);
  }
  ...
  public final void setupEnvironment() throws Exception {
    ...
    mAsyncHBaseKiji = new AsyncHBaseKijiFactory().open(mKiji.getURI());
    // Fill local variables.
    mTable = mAsyncHBaseKiji.openTable("user");
  ...
  public void testScanner() throws Exception {
    ...
    final KijiRowScanner scanner = getRowScanner(mReader, request, new KijiScannerOptions());
  ...
  public void testScannerOptionsStart() throws Exception {
    ...
    final KijiRowScanner scanner = getRowScanner(
        mReader,
        request,
        new KijiScannerOptions().setStartRow(startRow));
    final Iterator<KijiRowData> iterator = scanner.iterator();
