...
public class TestAsyncDataRequestAdapter extends KijiClientTest {
  private static final Logger LOG = LoggerFactory.getLogger(TestAsyncDataRequestAdapter.class);
