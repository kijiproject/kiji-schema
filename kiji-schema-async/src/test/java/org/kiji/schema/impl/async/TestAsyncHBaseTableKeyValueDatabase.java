 ...
 */
public class TestAsyncHBaseTableKeyValueDatabase extends KijiClientTest {
  private static final Logger LOG = LoggerFactory.getLogger(TestAsyncHBaseTableKeyValueDatabase.class);
  ...
  private AsyncHBaseTableKeyValueDatabase mDb;
  ...
  public final void setupHBaseTable() throws IOException {
    ...
    mDb = new AsyncHBaseTableKeyValueDatabase(mHBClient, Bytes.UTF8(TABLE_NAME), FAMILY_NAME);
