...
public class TestAsyncKijiResult extends KijiClientTest {
  ...
  private AsyncKiji mKiji;
  private AsyncKijiTable mTable;
  private AsyncKijiTableReader mReader;
  ...
  public void setupTestAsyncKijiResult() throws IOException {
    ...
    Kiji kiji = getKiji();
    mKiji = new AsyncKiji(kiji.getURI());
    mTable = AsyncKijiTable.downcast(mKiji.openTable("all_types_table"));
    mReader = (AsyncKijiTableReader) mTable.openTableReader();
  }

  @After
  public void cleanupTestAsyncKijiRowView() throws IOException {
    mTable.release();
    mReader.close();
    mKiji.release();
  }
