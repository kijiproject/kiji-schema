...
public class TestAsyncHBaseKijiResultScanner extends KijiClientTest {
  ...
  public void testResultScanner() throws IOException {
    for (int rowCacheSize : ImmutableList.of(0, 2, 3, 10)) {
      ...
      final AsyncHBaseKijiResultScanner<Utf8> scanner = mReader.getKijiResultScanner(REQUEST, options);
