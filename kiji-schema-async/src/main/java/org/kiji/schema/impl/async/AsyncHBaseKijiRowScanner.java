 ...
 */
@ApiAudience.Private
public final class AsyncHBaseKijiRowScanner implements KijiRowScanner {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseKijiRowScanner.class);
  private static final Logger CLEANUP_LOG =
      LoggerFactory.getLogger("cleanup." + AsyncHBaseKijiRowScanner.class.getName());
  ...
  public static class Options {
     ...
     * @return This options instance.
     */
    public Options withTable(AsyncHBaseKijiTable table) {
      mTable = table;
      return this;
    }
   ...
   */
  public AsyncHBaseKijiRowScanner(Options options) throws IOException {
    // TODO(gabe): Replace this with asynchbase
