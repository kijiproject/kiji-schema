 ...
 * </p>
 */
public class AsyncHBaseTableLayoutUpdater {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseTableLayoutUpdater.class);
   ...
   */
  public AsyncHBaseTableLayoutUpdater(
      final AsyncHBaseKiji kiji,
