...
@ApiAudience.Private
public final class AsyncHBaseKijiTableReaderBuilder implements KijiTableReaderBuilder {
   ...
   */
  public static AsyncHBaseKijiTableReaderBuilder create(
      final AsyncHBaseKijiTable table
  ) {
    return new AsyncHBaseKijiTableReaderBuilder(table);
  }
   ...
   * @param table HBaseKijiTable for which to build a reader.
   */
  private AsyncHBaseKijiTableReaderBuilder(
      final AsyncHBaseKijiTable table
  ) {
    mTable = table;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public AsyncHBaseKijiTableReader buildAndOpen() throws IOException {
    ...
    return AsyncHBaseKijiTableReader.createWithOptions(
