 ...
 */
@ApiAudience.Private
public final class AsyncHBaseKijiTableWriter implements KijiTableWriter {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseKijiTableWriter.class);
   ...
   */
  public AsyncHBaseKijiTableWriter(AsyncHBaseKijiTable table) throws IOException {
  ...
  public String toString() {
    return Objects.toStringHelper(AsyncHBaseKijiTableWriter.class)
