...
*/
@ApiAudience.Private
public final class AsyncHBaseTableKeyValueDatabase
   implements KijiTableKeyValueDatabase<AsyncHBaseTableKeyValueDatabase> {

 public static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseTableKeyValueDatabase.class);
  ...
  */
 public AsyncHBaseTableKeyValueDatabase(HBaseClient hbClient, byte[] tableName, String metaFamily) {
 ...
 /** {@inheritDoc} */
 @Override
 public AsyncHBaseTableKeyValueDatabase putValue(String table, String key, byte[] value)
     throws IOException {
