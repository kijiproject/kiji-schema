 ...
 * is used. To set the flush interval, call <code>setFlushInterva()</code> on the AsyncHBaseKiji object.
 * </p>
 *
 * <p>
 ...
 */
@ApiAudience.Private
public final class AsyncHBaseKijiBufferedWriter implements KijiBufferedWriter {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseKijiBufferedWriter.class);
   ...
   */
  public AsyncHBaseKijiBufferedWriter(AsyncHBaseKijiTable table) throws IOException {
    mTable = table;
