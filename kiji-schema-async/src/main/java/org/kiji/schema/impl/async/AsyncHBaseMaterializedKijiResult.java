 ...
 */
@ApiAudience.Private
public final class AsyncHBaseMaterializedKijiResult<T> implements KijiResult<T> {
   ...
   */
  private AsyncHBaseMaterializedKijiResult(
   ...
   */
  public static <T> AsyncHBaseMaterializedKijiResult<T> create(
      final EntityId entityId,
      final KijiDataRequest dataRequest,
    ...
    return new AsyncHBaseMaterializedKijiResult<T>(
        entityId,
        dataRequest,
        layout,
        columnTranslator,
  ...
  public <U extends T> AsyncHBaseMaterializedKijiResult<U> narrowView(final KijiColumnName column) {
    ...
    if (narrowRequest.equals(mDataRequest)) {
      return (AsyncHBaseMaterializedKijiResult<U>) this;
    }
    ...
    return new AsyncHBaseMaterializedKijiResult<U>(
        mEntityId,
        mDataRequest,
        mLayout,
        mColumnTranslator,
