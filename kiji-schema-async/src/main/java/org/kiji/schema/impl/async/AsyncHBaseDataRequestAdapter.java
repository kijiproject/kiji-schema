 ...
 */
@ApiAudience.Private
public final class AsyncHBaseDataRequestAdapter {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseDataRequestAdapter.class);
  ...
  /**
   * Creates a new AsyncHBaseDataRequestAdapter for a given data request using a given
   ...
   */
  public static AsyncHBaseDataRequestAdapter create(
      final KijiDataRequest kijiDataRequest,
      final HBaseColumnNameTranslator translator,
      final HBaseClient hbClient,
      byte[] tableName
  ) {
    return new AsyncHBaseDataRequestAdapter(kijiDataRequest, translator, hbClient, tableName);
  }
   ...
   * @param tableName The name of the table that the request is for.
   */
  private AsyncHBaseDataRequestAdapter(
      final KijiDataRequest kijiDataRequest,
      final HBaseColumnNameTranslator translator,
      final HBaseClient hbClient,
      byte[] tableName
