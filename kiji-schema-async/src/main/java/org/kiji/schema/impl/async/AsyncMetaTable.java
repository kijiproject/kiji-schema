...
import org.kiji.schema.layout.impl.AsyncTableLayoutDatabase;
 ...
 */
@ApiAudience.Private
public final class AsyncMetaTable implements KijiMetaTable {

  private static final Logger LOG = LoggerFactory.getLogger(AsyncMetaTable.class);
  private static final Logger CLEANUP_LOG =
      LoggerFactory.getLogger("cleanup" + AsyncMetaTable.class.getName());
  ...
  //     so we can call AsyncMetaTable thread-safe, too.
...
private AsyncMetaTable(
  ...
  this(
      ...
      tableName,
      hbClient,
      new AsyncTableLayoutDatabase(kijiURI, hbClient, tableName, LAYOUT_COLUMN_FAMILY, schemaTable),
      new AsyncTableKeyValueDatabase(hbClient, tableName, META_COLUMN_FAMILY));
}
 ...
 */
  ...
  public static void install(HBaseAdmin admin, KijiURI uri)
    ...
    tableDescriptor.addFamily(
      AsyncTableLayoutDatabase.getHColumnDescriptor(LAYOUT_COLUMN_FAMILY));
    tableDescriptor.addFamily(
      AsyncTableLayoutDatabase.getHColumnDescriptor(META_COLUMN_FAMILY));
  ...
  public String toString() {
    return Objects.toStringHelper(AsyncMetaTable.class)
        .add("uri", mKijiURI)
