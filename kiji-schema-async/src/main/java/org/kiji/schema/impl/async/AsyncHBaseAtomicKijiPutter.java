 ...
 *
 * Access via AsyncHBaseKijiWriterFactory.openAtomicKijiPutter(), facilitates guaranteed atomic
 ...
 */
@ApiAudience.Private
public final class AsyncHBaseAtomicKijiPutter implements AtomicKijiPutter {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncHBaseAtomicKijiPutter.class);
   ...
   */
  public AsyncHBaseAtomicKijiPutter(AsyncHBaseKijiTable table) throws IOException {
    // TODO(gabe): Replace this with asynchbase
    throw new UnsupportedOperationException("Not yet implemented to work with AsyncHBase");
