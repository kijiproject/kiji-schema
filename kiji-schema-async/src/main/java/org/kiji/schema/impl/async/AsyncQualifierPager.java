 ...
 */
@ApiAudience.Private
public final class AsyncQualifierPager implements Iterator<String[]>, Closeable {
  private static final Logger LOG = LoggerFactory.getLogger(AsyncQualifierPager.class);
