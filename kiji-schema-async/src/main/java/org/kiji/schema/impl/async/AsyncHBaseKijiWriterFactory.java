...
@ApiAudience.Private
public final class AsyncHBaseKijiWriterFactory implements KijiWriterFactory {
   ...
   *
   * @param table The AsyncHBaseKijiTable to which this writer factory's writers write.
   */
  public AsyncHBaseKijiWriterFactory(AsyncHBaseKijiTable table) {
    mTable = table;
  }
  ...
  public KijiTableWriter openTableWriter() throws IOException {
    return new AsyncHBaseKijiTableWriter(mTable);
  }

  /** {@inheritDoc} */
  @Override
  public AtomicKijiPutter openAtomicPutter() throws IOException {
    return new AsyncHBaseAtomicKijiPutter(mTable);
  }

  /** {@inheritDoc} */
  @Override
  public KijiBufferedWriter openBufferedWriter() throws IOException {
    return new AsyncHBaseKijiBufferedWriter(mTable);
  }
