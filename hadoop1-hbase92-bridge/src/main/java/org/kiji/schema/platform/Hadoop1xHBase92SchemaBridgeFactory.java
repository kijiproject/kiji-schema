...
/**
 * Factory for Hadoop 1.x and HBase 0.92-specific SchemaPlatformBridge implementation.
 */
@ApiAudience.Private
public final class Hadoop1xHBase92SchemaBridgeFactory extends SchemaPlatformBridgeFactory {
    ...
    try {
      Class<? extends SchemaPlatformBridge> bridgeClass =
          (Class<? extends SchemaPlatformBridge>) Class.forName(
              "org.kiji.schema.platform.Hadoop1xHBase92SchemaBridge");
