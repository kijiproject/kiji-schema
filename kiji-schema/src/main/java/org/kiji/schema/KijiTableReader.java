 ...
 *
 * <p>Utilizes {@link org.kiji.schema.EntityId} and {@link org.kiji.schema.KijiDataRequest}
 *  to return {@link org.kiji.schema.KijiRowData} or a {@link org.kiji.schema.KijiRowScanner}
 *  to iteratate across rows in a Kiji table.</p>
 *
 ...
 *      .newColumnsDef().withMaxVersions(3).add("foo", "bar");
