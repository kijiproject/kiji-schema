...
public interface KijiTool extends Configurable {
  /**
   * @return the name of the tool. This name is used by users to run
   * the tool. e.g., to provide the <tt>kiji ls</tt> tool, this should
   * return "ls".
   */
  String getName();

  /**
   * @return a short user-friendly description of the tool to print
   *     in help text.
   */
