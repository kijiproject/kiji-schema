...
public interface AsyncKijiWriterFactory {
   ...
   */
  AsyncKijiTableWriter openTableWriter() throws IOException;
   ...
   * @throws java.io.IOException in case of an error.
   */
  AsyncKijiBufferedWriter openBufferedWriter() throws IOException;
}
