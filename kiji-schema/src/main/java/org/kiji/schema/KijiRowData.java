...
public interface KijiRowData {
   ...
   * @see KijiTableLayout For more information about the layout of Kiji tables.
   * @see Schema For more information about Avro schemas.
   */
   ...
   *     {@link #containsColumn()} to distinguish between these scenarios.
   ...
   *     between Avro encoded nulls and non-existant cells. Use {@link #containsColumn()}
